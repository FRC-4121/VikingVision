...
This is necessary for drawing on a buffer with the [`draw`](draw.md) component, and its contents can be later accessed by [unpacking](unpack.md) the `inner` field.
